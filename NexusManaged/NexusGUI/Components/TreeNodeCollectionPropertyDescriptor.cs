...
namespace Nexus.GUI.Components
{
    ...
    /// </summary>
    public class TreeNodeCollectionPropertyDescriptor : PropertyDescriptor
    {
        private TreeNodeCollection collection;
        //private TreeNodeCollection collection = null;
        private int index = -1;

        public TreeNodeCollectionPropertyDescriptor(TreeNodeCollection coll, int idx) :
        ...
        public override string DisplayName
        {
            get
            {
                UIComp_TreeNodeBase item = this.collection[index];
                return item.Text;
            }
        }
