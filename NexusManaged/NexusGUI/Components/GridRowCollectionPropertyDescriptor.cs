...
namespace Nexus.GUI.Components
{
    ...
    /// </summary>
    public class GridRowCollectionPropertyDescriptor : PropertyDescriptor
    {
        private GridRowCollection collection;
        private int index = -1;

        public GridRowCollectionPropertyDescriptor(GridRowCollection coll, int idx) :
		...
		public override string DisplayName
		{
			get 
			{
                GridRow item = this.collection[index];
