...
{
	value struct Color4ub;

	namespace Design
	{
		/// <summary>
		/// Provides a type converter to convert <see cref="Color4ub"/> objects to and from various 
		/// other representations.
		/// </summary>
		public ref class Color4ubConverter : System::ComponentModel::ExpandableObjectConverter
		{
		private:
		...
		public:
			/// <summary>
			/// Initializes a new instance of the <see cref="Color4ubConverter"/> class.
			/// </summary>
			Color4ubConverter();
