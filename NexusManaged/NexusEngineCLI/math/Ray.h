...
namespace NexusEngine
{
	...
	[System::ComponentModel::TypeConverter( NexusEngine::Design::RayConverter::typeid )]
	...
	public:
		...
		//--
		static Ray FromNative(const nexus::ray& nv)
		{
			return Ray(Vector3::FromNative(nv.origin),
				Vector3::FromNative(nv.dir));
		}

		nexus::ray ToNative()
		{
			nexus::ray ret;
			ret.origin = Position.ToNative();
			ret.dir = Direction.ToNative();
			return ret;
		}
	};
}
