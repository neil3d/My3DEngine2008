...
namespace NexusEngine
{
	...
	public:
		...
		/// <summary>
		/// Transforms a 3D vector by the given <see cref="NexusEngine::Matrix"/>.
		/// </summary>
		/// <param name="vector">The source vector.</param>
		/// <param name="transformation">The transformation <see cref="NexusEngine::Matrix"/>.</param>
		/// <returns>The transformed <see cref="NexusEngine::Vector4"/>.</returns>
		...
		/// <param name="vector">The source vector.</param>
		/// <param name="transformation">The transformation <see cref="NexusEngine::Matrix"/>.</param>
		/// <param name="result">When the method completes, contains the transformed <see cref="NexusEngine::Vector4"/>.</param>
		static void Transform( Vector3% vector, Matrix% transformation, [Out] Vector4% result );

		/// <summary>
		/// Transforms an array of 3D vectors by the given <see cref="NexusEngine::Matrix"/>.
		/// </summary>
		...
		/// <param name="transformation">The transformation <see cref="NexusEngine::Matrix"/>.</param>
		/// <param name="vectorsOut">The transformed <see cref="NexusEngine::Vector4"/>s.</param>
		...
		/// <param name="transformation">The transformation <see cref="NexusEngine::Matrix"/>.</param>
		/// <returns>The transformed <see cref="NexusEngine::Vector4"/>s.</returns>
		//static array<Vector4>^ Transform( array<Vector3>^ vectors, Matrix% transformation );

		/// <summary>
		/// Transforms a 3D vector by the given <see cref="NexusEngine::Quaternion"/> rotation.
		/// </summary>
		/// <param name="vector">The vector to rotate.</param>
		/// <param name="rotation">The <see cref="NexusEngine::Quaternion"/> rotation to apply.</param>
		/// <returns>The transformed <see cref="NexusEngine::Vector4"/>.</returns>
		...
		/// <summary>
		/// Transforms an array of 3D vectors by the given <see cref="NexusEngine::Quaternion"/> rotation.
		/// </summary>
		...
		/// <summary>
		/// Performs a coordinate transformation using the given <see cref="NexusEngine::Matrix"/>.
		/// </summary>
		...
		/// <param name="inputStride">The stride in bytes between vectors in the input.</param>
		/// <param name="transformation">The transformation <see cref="NexusEngine::Matrix"/>.</param>
		/// <param name="coordinatesOut">The transformed coordinate <see cref="NexusEngine::Vector3"/>s.</param>
		/// <param name="outputStride">The stride in bytes between vectors in the output.</param>
		...
		/// <summary>
		/// Performs a normal transformation using the given <see cref="NexusEngine::Matrix"/>.
		/// </summary>
		...
		/// <param name="transformation">The transformation <see cref="NexusEngine::Matrix"/>.</param>
		/// <param name="normalsOut">The transformed <see cref="NexusEngine::Vector3"/>s.</param>
		/// <param name="outputStride">The stride in bytes between vectors in the output.</param>
		/// <param name="count">The number of vectors to transform.</param>
		...
		//--
		static Vector3 FromNative(const nexus::vector3& nv)
		{
			return Vector3(nv.x, nv.y, nv.z);
		}

		nexus::vector3 ToNative()
		{
