...
namespace NexusEngine
{
	...
	[System::ComponentModel::TypeConverter( NexusEngine::Design::Vector4Converter::typeid )]
	[XmlClassSerializable("Vector4",false)]
	...
	public:
		...
		/// <summary>
		/// Transforms a 4D vector by the given <see cref="NexusEngine::Matrix"/>.
		/// </summary>
		...
		/// <summary>
		/// Transforms an array of 4D vectors by the given <see cref="NexusEngine::Matrix"/>.
		/// </summary>
		...
		/// <summary>
		/// Transforms a 4D vector by the given <see cref="NexusEngine::Quaternion"/> rotation.
		/// </summary>
		...
		/// <summary>
		/// Transforms an array of 4D vectors by the given <see cref="NexusEngine::Quaternion"/> rotation.
		/// </summary>
		...
		//--
		static Vector4 FromNative(const nexus::vector4& nv)
		{
			return Vector4(nv.x, nv.y, nv.z, nv.w);
		}

		nexus::vector4 ToNative()
		{
			return nexus::vector4(x,y,z,w);
		}
	};
}
