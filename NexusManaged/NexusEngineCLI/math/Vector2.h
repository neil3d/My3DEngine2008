...
namespace NexusEngine
{
	...
	/// </summary>
	/// <unmanaged>nexus::vector2</unmanaged>
	[System::Serializable]
	...
	public:
		...
		/// <summary>
		/// Transforms a 2D vector by the given <see cref="NexusEngine::Matrix"/>.
		/// </summary>
		...
		/// <summary>
		/// Transforms an array of 2D vectors by the given <see cref="NexusEngine::Matrix"/>.
		/// </summary>
		...
		/// <summary>
		/// Transforms a 2D vector by the given <see cref="NexusEngine::Quaternion"/> rotation.
		/// </summary>
		...
		/// <summary>
		/// Transforms an array of 2D vectors by the given <see cref="NexusEngine::Quaternion"/> rotation.
		/// </summary>
