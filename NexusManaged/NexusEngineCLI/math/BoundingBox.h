...
namespace NexusEngine
{
	...
	public:
		...
		nexus::AABBox ToNative()
		{
			nexus::AABBox nbox;
			nbox.m_max = Maximum.ToNative();
			nbox.m_min = Minimum.ToNative();
			
			return nbox;
		}

		static BoundingBox FromNative(const AABBox& nbox)
		{
			BoundingBox box;
			box.Maximum = Vector3::FromNative(nbox.m_max);
			box.Minimum = Vector3::FromNative(nbox.m_min);
