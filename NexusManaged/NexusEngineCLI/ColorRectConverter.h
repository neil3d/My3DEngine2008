...
{
	value class ColorRect;

	namespace Design
	{
		/// <summary>
		/// Provides a type converter to convert <see cref="ColorRect"/> objects to and from various 
		/// other representations.
		/// </summary>
		public ref class ColorRectConverter : System::ComponentModel::ExpandableObjectConverter
		{
		private:
		...
		public:
			/// <summary>
			/// Initializes a new instance of the <see cref="ColorRectConverter"/> class.
			/// </summary>
			ColorRectConverter();
