...
namespace NexusEngine
{
	...
	{
		/// <summary>
		/// Provides a type converter to convert <see cref="FontDescription"/> objects to and from various 
		/// other representations.
		/// </summary>
		public ref class FontDescriptionConverter : System::ComponentModel::ExpandableObjectConverter
		{
		private:
		...
		public:
			/// <summary>
			/// Initializes a new instance of the <see cref="FontDescriptionConverter"/> class.
			/// </summary>
			FontDescriptionConverter();
