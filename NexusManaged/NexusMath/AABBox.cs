...
namespace Nexus.MathLib
{
    ...
    public sealed class AABBox : ICloneable
    {
        #region Fields
        ...
        private static readonly AABBox nullBox = new AABBox();
        ...
        ///		Returns a null box
        /// </summary>
        public static AABBox Null
        {
            get
            {
                AABBox nullBox = new AABBox();
        ...
        public static AABBox Parse(string text)
        {
            string[] parts = text.Split(':');
            return new AABBox(Vector3.Parse(parts[0]), Vector3.Parse(parts[1]));
        }
        public static AABBox FromDimensions(Vector3 center, Vector3 size)
        {
            Vector3 halfSize = .5f * size;
        ...
        public object Clone()
        {
            return new AABBox(this.minVector, this.maxVector);
        }
