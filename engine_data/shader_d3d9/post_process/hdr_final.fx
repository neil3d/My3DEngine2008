...
//  GLOBAL VARIABLES
//------------------------------------------------------------------
texture g_texSceneColor;	// The HDR data
texture g_texLum;			// The 1x1 luminance map
texture g_texBloom;			// The post processing results

sampler original_scene = sampler_state 
{
...
sampler luminance = sampler_state 
{
    Texture   = <g_texLum>;
    AddressU  = WRAP;
    AddressV  = WRAP;
...
float4 psTest(float2 uv : TEXCOORD0): COLOR
{
