...
namespace nexus
{
	...
	nrender_static_mesh* shape_func::create_box_rich(float width, float height, float depth)
	{
		...
		vertex_data.init(6*2*3, 1, 1);	// num_faces*triangle_per_face*vert_per_triangle
		...
		sec_stream->set_element(vert_index, 1,  vector2(0,0));
		pos_stream->set_element(vert_index++, 0,  pos_array[0]);

		sec_stream->set_element(vert_index, 0, vector3(0,1,0));
		sec_stream->set_element(vert_index, 1,  vector2(1,0));
		pos_stream->set_element(vert_index++, 0,  pos_array[3] );

		sec_stream->set_element(vert_index, 0, vector3(0,1,0));
		sec_stream->set_element(vert_index, 1,  vector2(1,1));
		...
		sec_stream->set_element(vert_index, 0, vector3(0,1,0));
		sec_stream->set_element(vert_index, 1,  vector2(0,1));
