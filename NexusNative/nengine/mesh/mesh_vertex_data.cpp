...
namespace nexus
{
	...
	void nmesh_vertex_data::init_pos_stream(size_t num_vert, bool xyzw)
	{
		EVertexElementType fmt = EVET_FLOAT3;
		if( xyzw )
			fmt = EVET_FLOAT4;
		vertex_element_define pos_def = {0, 0, fmt, EVEU_Position, 0};
