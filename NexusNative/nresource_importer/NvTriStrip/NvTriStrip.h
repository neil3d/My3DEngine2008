...
//GeForce3 and higher cache size
...
// This is the "actual" cache size, so 24 for GeForce3 and higher and 16 for GeForce1/2
...
//
// If validateEnabled == true, the output will be validated against the input, and the return value of false 
//   will mean failure, true means success.  This comes at a cost, so only enable if you're seeing issues
//
